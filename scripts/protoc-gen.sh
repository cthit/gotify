...
function generate_for_for_version {
  ...
  for f in $PROTOFILES; do
    ...
    protoc --proto_path=api/proto/$1 -I${GOPATH}/src/github.com/grpc-ecosystem/grpc-gateway/third_party/googleapis --swagger_out=allow_merge=true,logtostderr=true:api/swagger/$1 $(basename $f)
  done
}
